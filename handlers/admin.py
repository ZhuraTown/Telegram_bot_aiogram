...
async def get_table_time_sheet(call: CallbackQuery, state: FSMContext, callback_data: dict):
    ...
    for contractor in contractors:
        ...
        table_tb_sheet.write_total_nums_works_to_tb(comps)
